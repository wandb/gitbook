...
1. **Table**: All the runs in your project are listed in the table. _\*\*_Turn on and off runs, change colors, and expand the table to see notes, config, and summary metrics for each run. 
