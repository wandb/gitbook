...
[![](https://www.tensorflow.org/images/GitHub-Mark-32px.png)View source on GitHub](https://www.github.com/wandb/client/tree/v0.10.31/wandb/sdk/wandb_init.py#L558-L788)
...
At the end of your script, we will automatically call <code>wandb.finish(</code>) to
finalize and cleanup the run. However, if you call <code>wandb.init()</code> from a
child process, you must explicitly call <code>wandb.finish()</code> at the end of the
child process.
