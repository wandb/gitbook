...
* 검증 세트\(validation set\)에서 예시 예측 확인
...
* Lambda Labs에서 저희 시스템 메트릭 사용에 관한 포스팅을 작성했습니다. [해당 블로그 포스팅을 읽어보십시오 →](https://lambdalabs.com/blog/weights-and-bias-gpu-cpu-utilization/)
