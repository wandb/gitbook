...
* [Guides](guides/README.md)
  * [Artifacts](guides/artifacts/README.md)
    ...
    * [Create a new artifact version](guides/artifacts/create-a-new-artifact-version.md)
    * [Track external files](guides/artifacts/track-external-files.md)
    * [Delete artifacts](guides/artifacts/delete-artifacts.md)
    * [Explore and traverse an artifact graph](guides/artifacts/explore-and-traverse-an-artifact-graph.md)
