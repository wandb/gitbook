...
![Because we're only using OIDC for authentication and not authorization, public clients simplify setup](<../../.gitbook/assets/image (164).png>)
...
![openid, profile, and email are required](<../../.gitbook/assets/image (166).png>)
