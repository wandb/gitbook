...
![The closed_loop_score column sums the confidence scores for digits with typical loops (0, 6, 8, 9).](../../.gitbook/assets/screen-shot-2021-04-30-at-2.46.03-pm.png)
...
![After 5 epochs, the "double" variant is catching up to the baseline.](<../../.gitbook/assets/screen-shot-2021-05-03-at-5.47.19-pm (1) (1).png>)
{% endtab %}
{% endtabs %}
