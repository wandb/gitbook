...
4. **Log rich media and charts**: `wandb.log` supports the logging of a wide variety of data types, from [media like images and videos](create-a-new-artifact-version/media.md) to [tables](../data-vis/log-tables.md) and [charts](explore-and-traverse-an-artifact-graph/plots.md).

### In-**D**epth Guides

For in-depth information on how to log everything from histograms to 3d molecules, check out the guides below.

{% content-ref url="create-a-new-artifact-version/media.md" %}
[media.md](create-a-new-artifact-version/media.md)
{% endcontent-ref %}

{% content-ref url="explore-and-traverse-an-artifact-graph/plots.md" %}
[plots.md](explore-and-traverse-an-artifact-graph/plots.md)
{% endcontent-ref %}
