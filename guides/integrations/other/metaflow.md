...
| `others`            | <ul><li>Anything that is <a href="https://wiki.python.org/moin/UsingPickle">pickle-able</a></li></ul> |
...
For an example of this behaviour, please see this [notebook](https://colab.research.google.com/drive/1w4KfTWHUxeuAw4VnvMXYCLVqafgtSvQ-?usp=sharing) and its corresponding [W\&B Artifacts page](https://wandb.ai/megatruong/metaflow_integration/artifacts/dataset/raw_df/7d14e6578d3f1cfc72fe/graph)

### How can I add metadata to my artifacts if they are auto-logged?

You can update the `description`, `metadata`, and `aliases` as described in the [Artifacts Walkthrough](https://docs.wandb.ai/guides/artifacts/api#updating-artifacts).

Currently you will need to do this in a separate step because logging happens as the step is completed.
