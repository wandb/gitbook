...
* Passing a number to `--bbox_interval` will turn on [data visualization](../datasets-and-predictions/). At the end of every `bbox_interval` epochs, the outputs of the model on the validation set will be uploaded to W&B.
...
{% page-ref page="../datasets-and-predictions/" %}
