...
Try our integration out in a [colab notebook](http://wandb.me/keras-colab), complete with [video tutorial](http://wandb.me/keras-video), or see our [example projects]() for a complete script example.
