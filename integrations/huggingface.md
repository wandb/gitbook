...
# Hugging Face
 ...
 [Hugging Face Transformers](https://huggingface.co/transformers/)는 100개 이상의 언어 사전 훈련된 모델과 TensorFlow 2.0과 PyTorch간의 깊은 상호운영성\(deep interoperability\)을 통하여 Natural Language Understanding\(자연어 이해\) \(NLU\)와 Natural Language Generation\(자연어 생성\) \(NLG\)에 대한 다목적 아키텍처를 제공합니다.

훈련을 자동으로 로그하시려먼, 라이브러리를 설치하고 로그인하시기기만 하면 됩니다:
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <ul>
          <li><b>gradients</b> (default): &#xACBD;&#xC0AC;(gradients)&#xC758; &#xD788;&#xC2A4;&#xD1A0;&#xADF8;&#xB7A8;&#xC744;
            &#xB85C;&#xADF8;&#xD569;&#xB2C8;&#xB2E4;</li>
    ...
    <tr>
      ...
      <td style="text-align:left"><em><b>boolean</b>:</em>  <b>true</b>&#xB85C; &#xC131;&#xC808;&#xD558;&#xC5EC;
        &#xB85C;&#xAE45;&#xC744; &#xC644;&#xC804;&#xD788; &#xBE44;&#xD65C;&#xC131;&#xD654;
        &#xC2DC;&#xD0B5;&#xB2C8;&#xB2E4;</td>
    </tr>
  </tbody>
...
저희는 다음의 통합\(integration\)이 어떻게 작동하시는 확인할 수 있는 몇 가지 예시를 만들었습니다:

* [colab에서 실행](https://colab.research.google.com/drive/1NEiqNPhiouu2pPwDAVeFoN4-vTYMz9F8?usp=sharing): 시작을 위한간단한 notebook 예시
...
W&B 대시보드에서 결과를 동적으로 탐색합니다. 수 십개의 실험을 쉽게 살펴보고, 흥미로운 결과를 줌인 하실 수 있으며, 고차원 데이터를 시각화 하실 수 있습니다.
