# JAX Example
 ...
 これは、MLPをトレーニングしてW＆Bに保存するJAXコードの完全な例です。この例は[GitHub](https://github.com/wandb/examples/tree/master/examples/jax/jax-mnist)にあり、[W&B](https://app.wandb.ai/l2k2/examples-jax-mnist/runs/g0vgca81)で結果を確認できます。
