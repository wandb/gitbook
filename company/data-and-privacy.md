...
You can download data saved with Weights & Biases using our [export API](data-and-privacy.md). We want to make it easy to do custom analysis in notebooks, back up your data if you'd like to have a local copy, or plug your saved logs into other tools in your ML workflow.
