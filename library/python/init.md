...
Most of these settings can also be set with [Environment Variables](../advanced/environment-variables.md). This is often useful when you're running jobs on a cluster.
