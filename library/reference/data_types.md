...
# wandb.data_types
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L0)
...
## Image
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L668)
```python
...
## Graph
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L838)
```python
...
## Edge
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L1137)
```python
...
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L1269)
```python
plot_to_json(obj)
```
...
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L1284)
```python
