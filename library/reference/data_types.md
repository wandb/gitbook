...
# wandb.data_types
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L0)
...
## WBValue
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L40)
```python
WBValue(self)
```
...
## Histogram
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L59)
```python
...
## Table
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L117)
```python
...
## Media
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L150)
```python
...
## BatchableMedia
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L243)
```python
...
## Audio
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L255)
```python
...
## Object3D
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L352)
```python
...
## Html
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L458)
```python
...
## Video
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L524)
```python
...
## Image
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L668)
```python
...
## Graph
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L838)
```python
...
## Node
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L972)
```python
Node(self,
     id=None,
     name=None,
...
## Edge
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L1137)
```python
...
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L1269)
```python
plot_to_json(obj)
```
...
[source](https://github.com/wandb/client/blob/master/client/wandb/data_types.py#L1284)
```python
