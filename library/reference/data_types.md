...
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L1267)
```python
plot_to_json(obj)
```
...
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/data_types.py#L1282)
```python
