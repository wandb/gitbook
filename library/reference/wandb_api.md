...
* `name` _str_ - An artifact name. May be prefixed with entity/project. Valid names can be in the following forms: sequence\_name:version sequence\_name:alias digest
...
### ArtifactType.artifact\_collections
