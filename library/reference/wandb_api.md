...
## Api
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L91)
```python
Api(self, overrides={})
```
...
### Api.flush
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L160)
```python
Api.flush(self)
```
...
### Api.projects
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L195)
```python
...
### Api.runs
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L215)
```python
...
### Api.run
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L260)
```python
Api.run(self, path='')
```
...
### Api.sweep
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L277)
```python
Api.sweep(self, path='')
```
...
## Projects
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L388)
```python
...
## Project
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L442)
```python
...
## Runs
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L453)
```python
...
## Run
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L537)
```python
...
### Run.create
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L619)
```python
...
### Run.update
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L698)
```python
Run.update(self)
```
...
### Run.files
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L758)
```python
...
### Run.file
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L770)
```python
Run.file(self, name)
```
...
### Run.history
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L781)
```python
Run.history(self,
            samples=500,
            keys=None,
...
### Run.scan_history
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L813)
```python
...
## Sweep
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L866)
```python
...
### Sweep.get
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L939)
```python
Sweep.get(client,
          entity=None,
          project=None,
...
## Files
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L979)
```python
...
## File
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L1035)
```python
...
### File.download
[source](https://github.com/wandb/client/blob/HEAD/client/wandb/apis/public.py#L1079)
```python
